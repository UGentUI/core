...
import { i as y, S as u, x as b, _ as a, n as o, t as g } from "../../chunks/chunk.UYAO2JRR.js";
...
const z = [
  ...
  fadeInUpBig: ct,
  fadeOut: lt,
  fadeOutBottomLeft: dt,
  fadeOutBottomRight: pt,
  fadeOutDown: mt,
  fadeOutDownBig: yt,
  fadeOutLeft: ut,
  fadeOutLeftBig: bt,
  ...
  jello: k,
  lightSpeedInLeft: Rt,
  lightSpeedInRight: St,
  lightSpeedOutLeft: Lt,
  lightSpeedOutRight: Ct,
  pulse: w,
  rollIn: Wt,
  rollOut: Zt,
  rotateIn: Dt,
...
`, e = class extends u {
  ...
  async createAnimation() {
    var t, s;
    const n = (t = p[this.easing]) != null ? t : this.easing, r = (s = this.keyframes) != null ? s : le[this.name], i = (await this.defaultSlot).assignedElements()[0];
