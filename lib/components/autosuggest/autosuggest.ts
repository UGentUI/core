...
import styles from './autosuggest.styles.ts';
...
@customElement('ug-autosuggest')
export class UgAutosuggest extends LitElement {
  ...
  handleUgFocus = () => {
    ...
    if (this.meetsInputThreshold()) {
      ...
      this.dispatchEvent(new CustomEvent('ug-autosuggest-search'));
    }
