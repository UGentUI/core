...
export const Tag: Story = {
  ...
  const meta: Meta = {
      ...
      parameters: {
          docs: {
              subtitle: "Trees allow you to display a hierarchical list of selectable tree items. Items with children can be expanded and collapsed as desired by the user. TODO: If this page doesn't load, please try going to a story and then back to docs",
          },
      },
      ...
      argTypes: {
          ...
          selection: {
              control: "select",
              description: "The selection behavior of the tree. Single selection allows only one node to be selected at a time. Multiple displays checkboxes and allows more than one node to be selected. Leaf allows only leaf nodes to be selected.",
              options: [
                  "single",
                  "multiple",
                  "leaf",
          ...
          expandIconSlot: {
              control: "text",
              description: "The icon displayed when the tree item is expanded. Works best with `<sl-icon>`.",
              table: {
                  category: "Slots",
              },
          },
          collapseIconSlot: {
              control: "text",
              description: "The icon displayed when the tree item is collapsed. Works best with `<sl-icon>`.",
              table: {
                  category: "Slots",
              },
          },
          ...
          "--indent-size": {
              ...
              defaultValue: "var(--ug-spacing-medium)",
              table: {
                  category: "Custom Properties",
                  defaultValue: {
                      summary: "var(--ug-spacing-medium)",
                  },
              },
          },
          "--indent-guide-color": {
              ...
              defaultValue: "var(--ug-color-neutral-200)",
              table: {
                  category: "Custom Properties",
                  defaultValue: {
                      summary: "var(--ug-color-neutral-200)",
                  },
              },
          },
          "--indent-guide-offset": {
  ...
  export const FullFeatureTree: Story = {
      args: {
          selection: "single",
          "--indent-size": "var(--ug-spacing-medium)",
          "--indent-guide-color": "var(--ug-color-neutral-200)",
          "--indent-guide-offset": "5px",
      ...
      render: (args) => {
          ...
          <ug-tree selection="${args.selection}"
              style="
                  --indent-size: ${args["--indent-size"]};
                  --indent-guide-color: ${args["--indent-guide-color"]};
                  --indent-guide-offset: ${args["--indent-guide-offset"]};
                  --indent-guide-style: ${args["--indent-guide-style"]};
                  --indent-guide-width: ${args["--indent-guide-width"]};
              "
          >
  ...
  //TODO: better a story that illustrates some CSS
  export const CustomCSSProperties: Story = {
      ...FullFeatureTree,
      args: {
          ...FullFeatureTree.args,
          "--indent-guide-color": "red",
          "--indent-guide-offset": "15px",
          "--indent-guide-style": "dotted",
          "--indent-guide-width": "10px",
      },
      parameters: {
          docs: {
              description: {
                  story: `You can adjust the indent guides width color, offset, and style, using --indent-guide-width, --indent-guide-color, --indent-guide-style, and --indent-guide-offset, respectively.`,
              },
          },
      },
  };
