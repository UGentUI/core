...
//TODO: style elements
//You can control the size of tooltip arrows by overriding the --ug-tooltip-arrow-size design token. To remove them, set the value to 0 as shown below.
//--ug-tooltip-arrow-size: 0;
