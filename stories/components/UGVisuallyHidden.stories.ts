...
<div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'This story shows how to associate hidden content with visible elements using attributes like `aria-describedby` for accessibility purposes.'
      },
      canvas: {
        type: 'code',
        sourceState: 'shown'
...
export const ComplexInteraction = {
  ...
  render: () => html`
<div>
  <button aria-live="polite" @click=${() => alert("Action triggered")}>
    Perform Action
  </button>
  <ug-visually-hidden>
    This button performs a complex action when clicked.
  </ug-visually-hidden>
</div>
  `,
  parameters: {
    docs: {
      description: {
        story:
          'This story demonstrates how to include critical information for complex interactions, ensuring all users understand the action being performed.'
      },
      canvas: {
        type: 'code',
        sourceState: 'shown'
...
<div>
  <img
    src="https://www.ugain.ugent.be/images/info2b.jpg"
    width="500px"
    alt="Link voor opleidingsonderdelen"
  />
  <ug-visually-hidden>
    The text in the image is:
    <p>Niet meteen gevonden wat u zocht?</p>
    <p>
      <a>Klik hier</a> en zeg ons wat uw opleidingsnoden zijn
    </p>
  </ug-visually-hidden>
</div>
  `,
  parameters: {
    docs: {
      description: {
        story:
          'This story demonstrates how to add descriptive hidden text to an infographic, ensuring visually impaired users can access the same information presented in the graphic.'
      },
      canvas: {
        type: 'code',
        sourceState: 'shown'
