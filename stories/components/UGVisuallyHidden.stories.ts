...
export const ComplexInteraction = {
  ...
  render: () => html`
    <div>
      ...
      <ug-visually-hidden
        >This button performs a complex action when clicked.</ug-visually-hidden
      >
    </div>
  `,
  parameters: {
    docs: {
      description: {
        story:
          "Shows how to include critical information for complex interactions, ensuring all users understand the action being performed.",
      },
      canvas: {
        type: "code",
        sourceState: "shown",
